...
class DataProvider {
 public:
  ...
  void Yuyv2rgb(const uint8_t *YUV, uint8_t *RGB, int NumPixels);
  void YUV2RGB(const uint8_t y, const uint8_t u, const uint8_t v, uint8_t* r,
               uint8_t* g, uint8_t* b);
  uint8_t CLIPVALUE(int val);
