...
#include "modules/perception/camera/tools/transform_server.h"
...
class Visualizer {
 public:
  ...
  void DrawBoxes(cv::Mat &img, const CameraFrame &frame);
 ...
 private:
  std::string obs_sensor_intrinsic_path_ = "/work/share/apollo_ros";
